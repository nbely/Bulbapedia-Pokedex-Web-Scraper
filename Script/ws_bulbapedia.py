...
for x in pokeList[startIndex:endIndex]: #Pokemon total 1161 (up to Pokedex #1010)
  ...
  for f_num in range(num_formes):
    ...
    hp.append(str(hp_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    atk.append(str(atk_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    defense.append(str(def_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    spatk.append(str(spatk_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    spdef.append(str(spdef_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    spd.append(str(spd_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
    bst.append(str(bst_stats).replace(']', '').replace('[', '').replace("'", '').replace(' ', ''))
